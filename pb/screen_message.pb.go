...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpcProject.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x74, 0x22, 0x9b, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12, 0x1b,
	...
	0x1e, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x53, 0x63,
	...
	0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: grpcProject.Screen.Panel
	(*Screen)(nil),            // 1: grpcProject.Screen
	(*Screen_Resolution)(nil), // 2: grpcProject.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpcProject.Screen.resolution:type_name -> grpcProject.Screen.Resolution
	0, // 1: grpcProject.Screen.panel:type_name -> grpcProject.Screen.Panel
